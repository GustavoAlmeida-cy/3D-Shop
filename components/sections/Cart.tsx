...
const Cart = () => {
  ...
  return (
    <div className="fixed h-screen w-screen top-0 left-0 flex items-center justify-center z-50 bg-stone-950/75">
      <div className="w-[550px] h-[500px] md:h-[600px] bg-stone-800 rounded-3xl overflow-hidden">
        ...
        {cartItems.length > 0 ? (
          <div className="w-full h-max flex flex-col md:flex-row p-4 md:p-12 gap-8">
            ...
            <div className="w-full md:w-52 flex flex-row md:flex-col items-center justify-between border-t-2 md:border-t-0 border-slate-200 py-6 md:py-0 md:px-8">
          ...
          <p className="text-slate-400 text-center mt-32">
            👏 Thre's currently nothing is here!
          </p>
        )}
      </div>
    </div>
